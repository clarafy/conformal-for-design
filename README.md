...
See `assay.py` for implementations of the full and split conformal prediction algorithms we describe. Notebooks for reproducing and plotting the results of the simulated protein design experiments are as follows:
